...
const DoctorCard = ({doctor}) => {
  ...
  return (
    <div className='p-3 lg:p-5'>
        ...
        text-textheadingColor font-[700] mt-3 lg:mt-5'>{name}</h2>

        <div className='mt-2 lg:mt-4 flex items-center justify-between'>
            <span className='bg-[#CCF0F3] text-irisBlueColor py-1 px-2 lg:py-2 lg:px-6 
            text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded'>{specialty}</span>
            ...
            <div className='flex items-center gap-[6px]'>
                ...
                mt-[30px] flex items-center justify-center group hover:bg-primaryColor
                        hover:border-none'>
