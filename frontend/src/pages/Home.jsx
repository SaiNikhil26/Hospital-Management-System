            ...
            <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
                ...
                <div>
                    <div className='lg:w-[570px]'>
                        ...
                        <p className='text_para'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perspiciatis labore officia atque nesciunt neque, 
                        rerum maxime blanditiis iusto veritatis laborum dolores, commodi quis ex quos molestiae quasi fuga quas sunt.
                        </p>
    ...
    <section>
        <div className="container">
            <div className='lg:w-[470px] mx-auto'>
                ...
                <p className='text_para text-center'>World Class care for everyone. Our health System offers unmatches expert health care</p>
            </div>
            ...
            lg:mt-[55px]'>
                <div className='py-[30px] px-5'>
                    ...
                    <div className='mt-[30px]'>
                        ...
                        <p className='text-[16px] leading-7 text-textColor font-[400]'>World Class care for everyone. Our health System offers unmatches expert health care. From the lab to the clinic.</p>
                    ...
                    md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
                        <div className="flex items-center justify-between">
                            <div className='flex items-center gap-[6px] lg:gap-3'>
                                <p className='text-[10px] leading-[10px] lg:text-[14px] lg:leading-5 text-headingColor fonr-[600]'>Tue 24</p>
                                <p className='text-[10px] leading-[10px] lg:text-[14px] lg:leading-5 text-headingColor fonr-[600]'>10:00AM</p>
                            </div>
                        ...
                        <div className='flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]'>
                            ...
                            <h4 className='text-[10px] leading-3 lg:text-[16px] lg-leading-[22px] font-[700] text-headingColor'>Rooney</h4>
                        </div>
                    </div>
                    </div>
                {/* ===== feature content end ========== */}
